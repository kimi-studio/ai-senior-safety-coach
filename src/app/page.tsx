  ...
  return (
    <div className="min-h-screen overflow-hidden">
      <section className="page-container-wide section-pad lg:min-h-[72vh] lg:flex lg:items-center">
        <div className="w-full grid items-center gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:gap-20">
          <div className="space-y-12 text-center lg:text-left">
            <div className="space-y-7">
              ...
              <div className="inline-flex items-center justify-center lg:justify-start">
                <div className="hero-panel flex h-28 w-28 items-center justify-center rounded-[2.4rem]">
              ...
              <div className="space-y-6">
                ...
                <p className="mx-auto max-w-xl text-base leading-8 text-slate-600 sm:text-lg lg:mx-0">
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
              <div className="metric-card text-left">
                  ...
                  <p className="mt-3 text-xl font-bold text-slate-900">읽기 쉬운 UI</p>
                </div>
                <div className="metric-card text-left">
                  <p className="text-sm font-semibold text-slate-500">AI 코칭</p>
                  <p className="mt-3 text-xl font-bold text-slate-900">작고 실천 가능한 제안</p>
              </div>
              <div className="metric-card text-left sm:col-span-2 lg:col-span-1">
                <p className="text-sm font-semibold text-slate-500">보호자 연결</p>
                <p className="mt-3 text-xl font-bold text-slate-900">감시 아닌 안심</p>
              </div>
            </div>
            </div>
          </div>
          ...
          <div className="space-y-7 lg:space-y-10">
            <div className="hero-panel p-9 sm:p-11 lg:p-12">
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-5 rounded-[1.7rem] bg-white/14 p-6 backdrop-blur-sm">
                  {highlights.map((item) => (
                    <div key={item} className="flex items-start gap-4 rounded-2xl bg-white/10 p-5">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div className="surface-card p-7">
                ...
                <p className="mt-3 text-base leading-7 text-slate-600">정말 필요한 순간에만 보호자와 연결되도록 설계했어요.</p>
              </div>
            </div>
          </div>
        </div>
