  ...
  return (
    <div className="min-h-screen overflow-hidden">
      <section className="page-container-wide section-pad lg:min-h-[72vh] lg:flex lg:items-center">
        <div className="w-full grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          ...
          <div className="space-y-6 lg:space-y-7">
            <div className="hero-panel p-8 sm:p-10 lg:p-12">
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-4 rounded-[1.7rem] bg-white/14 p-5 backdrop-blur-sm">
                  {highlights.map((item) => (
                    <div key={item} className="flex items-start gap-3 rounded-2xl bg-white/10 p-5">
